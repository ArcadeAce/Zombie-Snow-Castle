...
public class WideReceiverZombieAnimationControl : MonoBehaviour
{
    ...
    private float animationEndThreshold = 0.95f; // Adjust this value based on your animation's length
    ...
    private void Update()
    {
        ...
        if (animator.GetCurrentAnimatorStateInfo(0).IsName("Wide receiver zombie dancing twerk") ||
            animator.GetCurrentAnimatorStateInfo(0).IsName("Wide receiver zombie quarterback pass") ||
            animator.GetCurrentAnimatorStateInfo(0).IsName("Wide receiver back hand hook"))
        {
