...
public class TaekwandoZombieAnimationControl : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (animator.GetCurrentAnimatorStateInfo(0).IsName("Taekwando zombie leg sweep") ||
            animator.GetCurrentAnimatorStateInfo(0).IsName("Taekwando zombie kick") ||
            animator.GetCurrentAnimatorStateInfo(0).IsName("Taekwando zombie inside cresent kick"))
        {
