...
// 2 The standard naming convention for scripts in Unity follows the PascalCase convention. PascalCase capitalizes the first letter of each word in the name, including the first word, without using spaces or underscores. This creates a clear and readable name for your script.
...
// 2 - When a script inherits from a base class, it means that the child script (PoisonZombie) will inherit all the methods and fields of the parent class (Enemy)and can also override or extend them as needed. This is a fundamental concept in object-oriented programming known as inheritance.
