...
public class FistOfFuryZombieAnimationControl : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (animator.GetCurrentAnimatorStateInfo(0).IsName("Fist of fury punching bag") ||
            animator.GetCurrentAnimatorStateInfo(0).IsName("Fist of fury fight a") ||
            animator.GetCurrentAnimatorStateInfo(0).IsName("Fist of fury fight b") ||
            ...
            animator.GetCurrentAnimatorStateInfo(0).IsName("Fist of fury quad punch"))
        {
