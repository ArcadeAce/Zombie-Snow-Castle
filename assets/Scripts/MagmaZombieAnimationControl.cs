...
public class MagmaZombieAnimationControl : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (animator.GetCurrentAnimatorStateInfo(0).IsName("Magma zombie fist fight b") ||
            animator.GetCurrentAnimatorStateInfo(0).IsName("Magma zombie quad punch"))
        {
